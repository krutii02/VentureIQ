  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Logo */}
        <Link to="/" style={{ display:'flex', alignItems:'center', gap:10, textDecoration:'none', alignSelf:'flex-start' }}>
              ...
              <form onSubmit={handleSubmit(onSubmit)} style={{ display:'flex', flexDirection:'column', gap:14 }} autoComplete="off">
                ...
                {selectedRole!=='ADMIN'&&(<>
                  <div style={{display:'flex',alignItems:'center',gap:10,marginTop:2}}>
                    ...
                    <span style={{fontSize:'0.75rem',color:'var(--clr-text-muted)',fontWeight:500,whiteSpace:'nowrap'}}>or continue with</span>
                    <div style={{flex:1,height:1,background:'var(--clr-border)'}}/>
                  </div>
        ...
        <div style={{ fontSize:'0.72rem', color:'var(--clr-text-muted)', textAlign:'center' }}>
          © 2025 VentureIQ · <Link to="/" style={{color:'var(--clr-text-muted)',textDecoration:'none'}}>Privacy Policy</Link>
        </div>
      </div>
